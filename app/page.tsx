  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-blue-50 to-purple-50">
            ...
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center">
                <div className="bg-white/30 backdrop-blur-sm rounded-full p-2 border border-white/20">
                  <Image src="/logo-light.png" alt="NM Financial Advisory" width={32} height={32} />
                </div>
                <span className="text-xl font-bold text-gray-900 ml-3">{"Mantas Molotkovas"}</span>
              </div>
          ...
          <div className="fixed right-0 top-0 h-full w-80 max-w-[85vw]">
            <div className="bg-white/90 backdrop-blur-xl border-l border-white/20 shadow-2xl h-full flex flex-col">
              ...
              <div className="flex items-center justify-between p-4 border-b border-white/20 flex-shrink-0">
                <div className="flex items-center">
                  <div className="bg-white/30 backdrop-blur-sm rounded-full p-2 border border-white/20">
                    <Image src="/logo-light.png" alt="NM Financial Advisory" width={20} height={20} />
                  </div>
                  <span className="text-base font-bold text-gray-900 ml-2">Nicholas Morgan</span>
                </div>
                <Button
                  variant="ghost"
                  size="sm"
              ...
              <div className="px-4 py-4 border-t border-white/20 flex-shrink-0 bg-white/20 backdrop-blur-sm">
                <h3 className="text-xs font-semibold text-gray-900 mb-3 uppercase tracking-wide">Kontaktai</h3>
                <div className="space-y-3 max-h-32 overflow-y-auto">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="text-xs font-medium text-gray-900">Telefonas</p>
                      <a
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="text-xs font-medium text-gray-900">El. paštas</p>
                      <a
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="text-xs font-medium text-gray-900">Biuras</p>
                      <a
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="space-y-6 mb-8 lg:mb-12">
              ...
              <p className="text-lg sm:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto lg:mx-0">
                Paversk savo finansinius tikslus realybe su individualizuotomis investavimo strategijomis, ekspertų
                patarimus ir įrodytais turto kūrimo metodais, pritaikytais būtent tau.
              </p>
            </div>
                ...
                <div className="relative">
                  <div className="bg-white/20 backdrop-blur-sm rounded-3xl p-4 border border-white/30 shadow-2xl">
                    <img
                      ...
                      alt="Nicholas Morgan - Financial Advisor"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="mb-16">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Išsamios finansų paslaugos</h2>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                Nuo investavimo planavimo iki būsto kredito konsultacijų - teikiu visapusiškus finansinius sprendimus,
                kad padėčiau jums pasiekti finansinius tikslus ir užtikrinti ateitį.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
            {services.map((service, index) => (
              <div key={index} className="group hover:scale-105 transition-all duration-300 h-full">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              <div className="bg-white/30 backdrop-blur-xl border border-white/20 rounded-2xl p-8 shadow-xl">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Kodėl rinktis mano pagalbą?</h2>
                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                  Aš esu čia tam, kad padėčiau jums pasiekti jūsų finansinius tikslus. Kartu išanalizuosime jūsų
                  dabartinę situaciją, nustatysime prioritetus ir sukursime veiksmų planą, kuris atitiks jūsų poreikius
                  ir galimybes.
                </p>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-12 shadow-2xl">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Pasiruošę keisti savo finansinę ateitį?</h2>
            <p className="text-xl text-emerald-100 mb-8 leading-relaxed">
              Ženkite pirmą žingsnį link finansinės laisvės su nemokama konsultacija. Aptarkime jūsų tikslus ir
              sukurkime individualizuotą strategiją jūsų sėkmei.
            </p>
            <Link href="/consultation">
              <Button
                size="lg"
              ...
              >
                <Calendar className="mr-2 h-5 w-5" />
                Užsisakyti nemokamą konsultaciją šiandien
              </Button>
            </Link>
          </div>
        </div>
      ...
      <section id="contact" className="py-20 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Susisiekite su manimi</h2>
            <p className="text-xl text-gray-700">
              Pasiruošę pradėti savo finansinę kelionę? Susisiekite su manimi šiandien.
            </p>
          </div>
