        ...
        <Card className="w-full max-w-md mx-4 bg-white/30 backdrop-blur-xl border border-white/20 shadow-xl relative z-10">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Jūsų konsultacijos užklausa sėkmingai pateikta. Susisieksiu su
              jumis per 24 valandas.
            </p>
            <Link href="/">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Užpildykite formą ir susisieksiu su jumis per 24 valandas, kad
            aptartume jūsų finansinius tikslus ir galimybes.
          </p>
        </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    <p className="text-xs text-gray-600 leading-relaxed">
                      ...
                      . Jūsų duomenys bus naudojami tik konsultacijos tikslais
                      ir nebus saugomi sistemose.
                    </p>
                  </div>
